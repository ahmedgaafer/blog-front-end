	...
	return (
		<div className={classes.root}>
			<div className={classes.header}>
				...
				></Avatar>
				<NavLink to={`/profile/${user._id}`} className={classes.link}>
					{_.startCase(_.toLower(user.username))}
				</NavLink>
			</div>
					...
					<div className={classes.newCommentRoot}>
						<TextValidator
							...
							errorMessages={[
								...
								"The comment must contain at least 1 character",
							]}
						/>
